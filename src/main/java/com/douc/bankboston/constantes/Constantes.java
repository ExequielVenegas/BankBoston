package com.douc.bankboston.constantes;
...
public class Constantes {
    ...
    public static final String OPCION_REGISTRAR_CLIENTE = "1";
    public static final String OPCION_VER_DATOS_CLIENTE = "2";
    ...
    public static final List<String> LISTA_OPCIONES = Arrays.asList(OPCION_REGISTRAR_CLIENTE, OPCION_VER_DATOS_CLIENTE, OPCION_DEPOSITAR_CUENTA,
            OPCION_GIRAR_CUENTA, OPCION_CONSULTAR_SALDO, OPCION_SALIR);
}
